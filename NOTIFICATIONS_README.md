...
- 🎨 **Персонализация** — настройка обращения (ты/Вы) и стиля подачи (Поддерживающий/Сдержанный/Требовательный)
...
2. Перейти в `/therapy` или `/habits` → включить уведомления, выбрать **частоту** и **Стиль уведомлений**
