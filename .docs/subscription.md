...
| **PRO**     | 349 ₽      | 100                   | Пользователь, которому нужен регулярный текстовый ИИ-чат без «тяжёлых» ИИ-функций |
| **Premium** | 649 ₽      | Безлимит\*            | Активный пользователь, которому нужен максимальный ИИ-функционал                  |
...
3. Цена: крупно (`0 ₽`, `349 ₽`, `649 ₽`) + подпись `в месяц`/`в год`.
