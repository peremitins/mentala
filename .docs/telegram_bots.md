...
Базовый вариант (префикс `NUXT_` — Nitro подхватывает их при runtime в production):

- `NUXT_TELEGRAM_ALERTS_BOT_TOKEN`
- `NUXT_TELEGRAM_ALERTS_CHAT_ID`
- `NUXT_TELEGRAM_REPORTS_TIMEZONE`
- `NUXT_TELEGRAM_ALERTS_DELIVERY_CLEANUP_ENABLED`
- `NUXT_TELEGRAM_ALERTS_DELIVERY_RETENTION_DAYS`
- `NUXT_TELEGRAM_ALERTS_ENV_LABEL`
- `NUXT_TELEGRAM_API_TIMEOUT_MS`
- `NUXT_TELEGRAM_HTTP_5XX_SPIKE_THRESHOLD`
- `NUXT_TELEGRAM_HTTP_5XX_SPIKE_WINDOW_MINUTES`
- `NUXT_TELEGRAM_PUSH_DEGRADATION_ERROR_RATE_PERCENT`
- `NUXT_TELEGRAM_PUSH_DEGRADATION_MIN_ATTEMPTS`
- `NUXT_TELEGRAM_PUSH_DEGRADATION_WINDOW_MINUTES`
