...
- SEO-копирайт главной страницы должен раскрывать конкретные функции продукта, а не абстрактную «психологическую поддержку»: ИИ-чат, дыхательные практики, медитации, дневник благодарности, работа с полезными привычками и отказом от вредных
- Формулировку про доступ не писать как «Начните бесплатно или попробуйте Premium на 7 дней»; использовать короткую фактическую подачу в духе «Есть бесплатный режим, новым пользователям — 7 дней Premium»
