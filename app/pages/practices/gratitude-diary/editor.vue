    ...
    <div class="h-dvh flex flex-col pb-[170px] overflow-auto space-y-2">
      ...
      <section class="glass-deep p-4 space-y-3">
        ...
        <template v-else>
          ...
          <div v-if="isPromptVisible" class="relative">
            <p class="pr-7 text-md font-semibold leading-tight text-foreground">
      ...
      <section class="glass-deep flex flex-col h-full p-4 space-y-3">
        ...
        >
          ...
          <button
            type="button"
            class="absolute right-14 bottom-2 flex h-10 w-10 items-center justify-center rounded-full border border-white/15 bg-white/5 text-foreground transition hover:border-white/25 hover:bg-white/10"
