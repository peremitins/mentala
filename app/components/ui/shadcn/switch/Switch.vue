...
const rootClasses = computed(() =>
  cn(
    ...
    'data-[state=checked]:bg-primary-ui/20',
    props.class
  )
);
...
const thumbClasses = computed(() =>
  cn(
    'pointer-events-none block h-4 w-4 rounded-full border border-primary-ui bg-transparent shadow-lg ring-0 transition-transform',
    'translate-x-0 data-[state=checked]:translate-x-6 data-[state=checked]:bg-primary-ui',
    props.thumbClass
  )
);
</script>
