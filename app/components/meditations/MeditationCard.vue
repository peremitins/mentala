<template>
  <button
    type="button"
    class="group relative flex w-[78vw] min-w-[240px] max-w-[320px] sm:w-72 flex-col overflow-hidden rounded-3xl text-left transition-all duration-300 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-primary/60"
