...
async function runGetOrGeneratePlantSummary(params: {
  ...
  // Push о готовом финальном отчёте — только при успешной генерации LLM
  // (fallback-текст не достоин push'а) и наличии mirrored записи (push
  // защищён idempotency через pushSentAt).
