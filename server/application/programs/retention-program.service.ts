...
const STEP_BLUEPRINTS_CALM_ANXIETY_30: StepBlueprint[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      journalAction({
        prompt:
          'Если хочешь, коротко опиши, что в последние дни сильнее всего усиливало тревогу. Не нужно полной картины, достаточно одной фразы.',
        placeholderText:
          'Например: вечером начинаю прокручивать рабочий разговор и не могу уснуть.',
  ...
  },
  {
    ...
    actions: [
      ...
      microReflectionAction({
        ...
        question:
          'В когнитивной терапии заметить, что мысль - это ещё не приказ к действию, уже сильно ослабляет её власть. Какое описание тревоги сейчас тебе ближе? Выбери вариант, который кажется честным, без насилия над собой.',
        chips: [
          'Это сигнал защиты',
          'Это не факт опасности',
          'Это телесная реакция',
          'Это мысль, а не приказ',
          'Пока сложно поверить',
        ],
      }),
      journalAction({
        prompt:
      ...
      journalAction({
        ...
        helpHint: {
          ...
          examples: [
            ...
            'Действие или избегание: что в итоге сделал или, наоборот, отложил. Например, перечитал сообщение 10 раз вместо ответа.',
          ],
        },
      }),
    ],
  ...
  },
  {
    ...
    actions: [
      meditationAction({
        ...
        durationSeconds: 180,
        prompt:
          'Медленно переводи внимание от макушки к стопам. Если замечаешь напряжение, тяжесть или пустоту, просто отметь это. Ничего не нужно менять прямо сейчас.',
      }),
      thoughtDumpAction({
  ...
  },
  {
    ...
    actions: [
      ...
      aiChatAction({
        ...
        goalHint:
          'Выбрать одно действие, которое можно ослабить без насилия над собой.',
        minDurationSec: 180,
        minQualifyingMessages: 3,
      }),
      journalAction({
...
const STEP_BLUEPRINTS_SELF_KINDNESS_21: StepBlueprint[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      journalAction({
        idSuffix: 'critic-purpose',
        title: 'Один вывод',
        prompt:
          'Закончи фразу: «Мой критик чаще всего пытается защитить меня от...»',
        journalFormat: 'oneLine',
        maxLength: 240,
      }),
    ],
    ...
    actions: [
      ...
      structuredFormAction({
        ...
        helpHint: {
          ...
          description:
            'Действие должно быть настолько маленьким, чтобы его можно было попробовать без насилия над собой. Если план звучит как наказание, уменьшай его. Если нужна помощь другого человека, это тоже можно записать как часть плана.',
          examples: [
  ...
  },
  {
    ...
    actions: [
      ...
      structuredFormAction({
        ...
        helpHint: {
          title: 'Что считать границей',
          description:
            'Граница с собой - это заранее выбранное условие, при котором ты уменьшаешь нагрузку, делаешь паузу или переносишь задачу. Она не отменяет рост, но защищает от режима «терпеть любой ценой».',
          examples: [
            '«Я остановлюсь, если начну перечитывать одно сообщение больше пяти раз».',
        ...
        fields: [
          {
            id: 'pressure_area',
            label: 'Где я сейчас давлю на себя сильнее всего?',
            type: 'choice',
            mode: 'single',
            options: makeChoiceOptions([
              'работа/учёба',
          ...
          {
            id: 'critic_rule',
            label: 'Какое правило диктует критик?',
            type: 'textarea',
            maxLength: 300,
            required: true,
          },
          ...
          {
            id: 'first_signal',
            label: 'По какому сигналу я пойму, что пора остановиться?',
            type: 'textarea',
            maxLength: 240,
          },
        ],
      ...
      journalAction({
        ...
        title: 'Фраза границы',
        prompt:
          'Запиши короткую фразу: «Мне можно...» или «Я остановлюсь, когда...»',
        journalFormat: 'oneLine',
        maxLength: 240,
      }),
    ],
  ...
  {
    title: 'Доброта к телу в обычный день',
    subtitle: 'Связываем самоподдержку с повседневной заботой о теле.',
    nextHint: 'Дальше соберём план на трудный день.',
    introText:
      'Тело часто становится местом требований: выглядеть, работать, не мешать, терпеть. Сегодня мы попробуем другой вопрос: что телу нужно в обычный день, без проекта «стать идеальным»?',
    durationMin: 9,
    actions: [
      meditationAction({
        idSuffix: 'body-kindness',
        title: 'Нейтральная доброта к телу',
        template: 'body_kindness_neutral',
        durationSeconds: 420,
        prompt:
          'Практика не требует любить тело. Достаточно относиться к нему как к живой системе, которой нужна забота.',
      }),
      guidedStepsAction({
        idSuffix: 'body-care-check',
        title: 'Проверка базовых потребностей',
        formKind: 'body_care_check',
        steps: [
          {
            id: 'water',
            title: 'Вода и еда',
            text: 'Есть ли базовая потребность, которую можно закрыть без идеальности?',
          },
          {
            id: 'rest',
            title: 'Отдых',
            text: 'Нужна ли короткая пауза, сон, снижение шума?',
          },
          {
            id: 'movement',
            title: 'Движение',
            text: 'Нужно ли телу мягкое движение или наоборот меньше нагрузки?',
          },
          {
            id: 'care',
            title: 'Уход',
            text: 'Есть ли маленькое действие заботы: душ, тепло, лекарство по назначению, запись к врачу?',
          },
        ],
      }),
      microReflectionAction({
  ...
  },
  {
    ...
    actions: [
      ...
      structuredFormAction({
        ...
        helpHint: {
          title: 'Зачем план трудного дня',
          description:
            'Этот план нужен не для идеального контроля, а для момента, когда критик стал громче и сил меньше. Заполняй его как инструкцию для себя в трудный день: что упростить, к чему вернуться и куда обратиться, если станет небезопасно.',
          examples: [
            'Ранний сигнал: «я перестаю отвечать людям и всё откладываю».',
            'Упростить: «перенести одну задачу, поесть, сделать заземление».',
            'Поддержка: имя человека, специалист, местная экстренная служба или маршрут срочной поддержки в приложении.',
          ],
        },
        fields: [
          {
      ...
      journalAction({
        ...
        title: 'Разрешение упростить',
        prompt:
          'Запиши фразу, которая разрешает тебе снизить нагрузку в трудный день.',
        journalFormat: 'oneLine',
        maxLength: 240,
      }),
    ],
  },
  {
    ...
    subtitle: 'Собираем личный набор техник для дальнейшего использования.',
    nextHint: 'Дальше завершим сад и подготовим переход.',
    introText:
      'За сад ты {попробовал|попробовала} разные способы быть на своей стороне: дыхание, пауза, карточка мысли, наставник, ценности, просьба о поддержке, границы. Сегодня соберём не идеальный список, а набор, к которому реально можно вернуться.',
    miniArticle: {
      title: 'Личный набор лучше универсального совета',
      body: 'Самоподдержка работает лучше, когда она конкретна. Одному человеку помогает короткая фраза, другому - телесная пауза, третьему - карточка мысли или просьба о помощи. Универсальный совет часто звучит красиво, но не попадает в момент.\n\nВ программах самопомощи важна переносимость навыка: пользователь должен понимать, когда применять инструмент, как начать и что делать, если он не сработал. Поэтому сегодня мы соберём набор по ситуациям, а не просто «любимые практики».\n\nЕсли какая-то техника не подошла, её не нужно заставлять себя любить. В набор попадает только то, что выглядит хоть немного доступным, честным и безопасным.',
      sourceNotes: [
    ...
    actions: [
      breathingAction({
        ...
        durationSeconds: 240,
        prompt:
          'Коротко собери внимание перед итоговой формой. Мы выбираем не всё подряд, а то, к чему ты реально вернёшься.',
      }),
      structuredFormAction({
        ...
        fields: [
          {
            id: 'body_tool',
            label:
              'Что помогает, когда тело напряжено? Можно выбрать несколько вариантов.',
            type: 'choice',
            mode: 'multiple',
            options: makeChoiceOptions([
              'мягкий выдох',
          ...
          },
          {
            id: 'thought_tool',
            label:
              'Что помогает, когда критик становится громким? Можно выбрать несколько вариантов.',
            type: 'choice',
            mode: 'multiple',
            options: makeChoiceOptions([
              'посмотреть на мысль со стороны',
              'разобрать мысль через факты',
              'фраза наставника',
          ...
          },
          {
            id: 'action_tool',
            label:
              'Что помогает, когда нужно перейти к действию? Можно выбрать несколько вариантов.',
            type: 'choice',
            mode: 'multiple',
            options: makeChoiceOptions([
              'выбрать один маленький шаг',
              'разобрать ошибку спокойно',
              'попросить о поддержке',
              'снизить нагрузку или сделать паузу',
              'вспомнить план на трудный день',
              'ничего из этого',
            ]),
          },
          {
            id: 'one_phrase',
            label: 'Главная фраза сада',
            type: 'textarea',
            maxLength: 300,
            required: true,
          },
      ...
      guidedStepsAction({
        ...
        helpHint: {
          title: 'Зачем репетировать',
          description:
            'Набор легче использовать, если заранее представить один реальный сценарий. Это короткая проверка: какой инструмент будет первым и что делать, если он не подойдёт.',
          examples: [
            'Сценарий: после сложного разговора я начинаю себя ругать.',
            'Первый инструмент: фраза наставника и мягкий выдох.',
            'Запасной вариант: написать одному человеку или снизить нагрузку.',
          ],
        },
        steps: [
          {
            ...
            text: 'Представь маленький трудный момент ближайших дней.',
          },
          {
            id: 'pick',
            title: 'Подбери инструмент',
            text: 'Какой пункт набора ты применишь первым?',
          },
          {
            id: 'fallback',
            title: 'Добавь запасной вариант',
            text: 'Если не сработает, что будет проще?',
          },
        ],
      }),
      journalAction({
        idSuffix: 'toolkit-keep',
        title: 'Что беру дальше',
        prompt:
          'Запиши 2-3 пункта набора, которые выглядят наиболее живыми для тебя.',
        journalFormat: 'short',
        maxLength: 500,
      }),
    ],
  },
  {
    ...
    actions: [
      meditationAction({
        ...
        durationSeconds: 600,
        prompt:
          'Мягкая завершающая практика. Несколько минут спокойного дыхания и тёплого присутствия с собой. Ничего не нужно подводить или решать. Просто побудь в спокойствии и доброжелательности к себе.',
      }),
      structuredFormAction({
        idSuffix: 'completion-summary',
        title: 'Личный вывод сада',
        formKind: 'self_kindness_completion_summary',
        helpHint: {
          title: 'Как подвести итог',
          description:
            'Итог сада - не оценка, насколько ты {стал|стала} «лучше». Это короткая фиксация: какой навык оказался полезным, какой старый сценарий ты теперь замечаешь быстрее и какую фразу берёшь дальше.',
          examples: [
            'Навык: пауза самоподдержки.',
            'Старый сценарий: после ошибки сразу называю себя {плохим|плохой}.',
            'Фраза дальше: «мне нужен один следующий шаг, а не самонаказание».',
          ],
        },
        fields: [
          {
            id: 'most_useful_skill',
            label: 'Какой навык оказался для тебя самым полезным?',
            type: 'choice',
            mode: 'single',
            options: makeChoiceOptions([
              'пауза самоподдержки',
          ...
          {
            id: 'old_pattern',
            label: 'Какой старый сценарий я теперь замечаю быстрее?',
            type: 'textarea',
            maxLength: 400,
          },
          {
            id: 'future_phrase',
            label: 'Фраза, которую беру дальше',
            type: 'textarea',
            maxLength: 300,
            required: true,
          },
      ...
      aiChatAction({
        ...
        title: 'Финальный вывод с ассистентом',
        topicPrompt:
          'Ты {прошёл|прошла} весь сад «Доброта к себе». Давай подведём честный итог: какой навык оказался самым полезным, где самокритика всё ещё возвращается и что ты берёшь с собой дальше.',
        goalHint:
          'Зафиксировать один полезный навык, одну трудную зону и один план поддержки на ближайшую неделю. Без мотивационных клише и оценки прогресса.',
        minQualifyingMessages: 4,
        minDurationSec: 240,
      }),
      selfKindnessWeeklyCheckAction({
...
const THOUGHT_CATALOG: ThoughtEntry[] = [
  ...
  {
    text: 'Возвращаться к себе после трудного - навык. Не интуиция, не черта характера. Именно навык, который развивается через практику.',
    tags: ['self_compassion'],
  },
  {
...
const COMING_SOON_TEASERS: ProgramTeaser[] = [
  ...
  },
  {
    ...
    title: 'Привычки тела',
    subtitle:
      'Базовые ритуалы, которые поддерживают тело без насилия над собой',
    plantSetSlug: null,
    totalSteps: 21,
    themes: ['habits', 'body'],
  ...
  const attempt = await db.transaction(async (tx) => {
    ...
    const [createdAttempt] = await tx
      ...
      .values({
        ...
        status: 'started',
        replay: shouldReplay,
        actions: templateAttemptActions,
        rewardGranted: false,
        metadata: {},
      })
      .returning();
