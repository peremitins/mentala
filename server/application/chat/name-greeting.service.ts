...
// Чистая логика отбора имени вынесена в shared, чтобы её использовал и клиент
// (приветствие на главном экране). Реэкспортируем для обратной совместимости —
// roadmap-entry.service и тесты импортируют extractGreetingName отсюда.
import { extractGreetingName } from '../../../shared/utils/greetingName';

export { extractGreetingName };
